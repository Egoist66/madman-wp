...
$opt_name = 'madman_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Site Settings', 'madman' ),
		'id'               => 'site_settings',
...
Redux::setSection($opt_name, array(
    'title' => esc_html__('Header Settings', 'madman'),
    'id' => 'header_settings',
    'subsection' => true,
    'customizer_width' => '400px',
    'desc' => esc_html__('These are really basic fields!', 'madman'),
    'fields' => array(
        array(
            'id' => 'logo',
            'type' => 'media',
            'title' => esc_html__('Logo', 'madman'),
            'compiler' => 'true',
            //'mode' => 'image',
            'url' => true,
            'desc' => esc_html__('Upload your logo here', 'madman'),
            'subtitle' => esc_html__('Here you can upload your logo', 'madman'),
        ),

        array(
            'id' => 'phone_number',
            'type' => 'text',
            'title' => esc_html__('Phone Number', 'madman'),
            'desc' => esc_html__('Field for phone number', 'madman'),
            'subtitle' => esc_html__('Write your phone number', 'madman'),
